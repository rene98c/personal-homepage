    ...
    <div className="bg-white py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="text-base font-semibold leading-7 text-indigo-600">Technical Capabilities</h2>
          <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            Comprehensive Skill Set
          </p>
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Throughout my career, I&apos;ve developed expertise in a wide range of technologies, 
            frameworks, and methodologies. Here&apos;s a detailed overview of my technical skills.
          </p>
        </div>
