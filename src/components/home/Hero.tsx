        ...
        <div className="px-6 pt-16 md:pt-0 md:px-0 z-10">
          <div className="mx-auto max-w-2xl">
            <div className="max-w-lg">
              ...
              <h1 className={`mt-6 md:mt-10 text-4xl md:text-5xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-7xl transition-all duration-700 ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                Rene Prost
              </h1>
